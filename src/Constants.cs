namespace CommonServiceLocator
{
    public static class Constants
    {
        ...
        //Message shown if ServiceLocator.Current called before ServiceLocatorProvider is set.
        public const string ServiceLocatorProviderNotSetMessage =
            " ServiceLocatorProvider must be set.";                                          
    }
}
